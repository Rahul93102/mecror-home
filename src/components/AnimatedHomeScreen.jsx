  ...
  return (
    <BackgroundLines 
      style={{
        ...
        height: "100vh",
        margin: 0,
        background: "linear-gradient(135deg, #ffffff 0%, #f0f8ff 50%, #f3e8ff 100%)",
        overflow: "hidden"
      }}
    >
      {/* Animated Logo/Icon */}
      ...
      >
        Advanced analytics for referral networks with BFS algorithms, influencer identification, 
        network simulation, and optimization strategies. Comprehensive solution for Parts 1-5 
